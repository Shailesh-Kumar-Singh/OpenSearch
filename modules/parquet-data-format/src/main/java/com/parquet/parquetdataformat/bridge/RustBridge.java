...
public class RustBridge {
    ...
    public static native void createWriter(String file, String indexName, long schemaAddress, List<String> sortColumns, List<Boolean> reverseSorts) throws IOException;
    ...
    public static native void mergeParquetFilesInRust(List<Path> inputFiles, String outputFile, String indexName, List<String> sortKeys, List<Boolean> reverseSorts);
}
